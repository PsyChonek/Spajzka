...
async function migrate() {
  ...
  try {
    ...
    console.log('\nSummary:');
    console.log(`  - Migrated ${groups.length} groups to new schema`);
    console.log(`  - Processed items from old collection (if any)`);
    console.log(`  - Updated ${pantryUpdated} pantry item references`);
    console.log(`  - Updated ${shoppingUpdated} shopping item references`);
    console.log(`  - Ensured all users have a group (personal or shared)`);
