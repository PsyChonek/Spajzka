            ...
            <div className='content'>
                <div className="page">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Application</strong> refers to Špajzka, the software program provided by the Company.</p>
                        </li>
                        <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Špajzka.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Špajzka, accessible from <a href="https://spajzka.vazacdaniel.com/" rel="external nofollow noopener" target="_blank">https://spajzka.vazacdaniel.com/</a></p>
                        </li>
                        <li>
